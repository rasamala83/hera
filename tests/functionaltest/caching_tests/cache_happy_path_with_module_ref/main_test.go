...
func cfg() (map[string]string, map[string]string, testutil.WorkerType) {
	...
	appcfg["cache_key_module_ref"] = "occ-user_r1"
...
// GET (Cache MISS) + SET
func TestTTLCacheHappyPathWithCustomModuleName(t *testing.T) {
	logger.GetLogger().Log(logger.Debug, "TestTTLCacheHappyPathWithCustomModuleName begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
	...
	if testutil.RegexCountFile("key inside getKey.*occ-user_r1", "hera.log") < 2 {
		t.Fatalf("Error: should construct key with reference OCC module name")
	}
	conn.Close()

	logger.GetLogger().Log(logger.Debug, "TestTTLCacheHappyPathWithCustomModuleName done +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
}
