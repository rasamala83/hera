...
// GET (Cache MISS) + SET
func TestTTLCacheHappyPathWithDefaultModuleNameKey(t *testing.T) {
	logger.GetLogger().Log(logger.Debug, "TestTTLCacheHappyPathWithDefaultModuleNameKey begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
	...
	if testutil.RegexCountFile("key inside getKey.*hera-test", "hera.log") < 2 {
		t.Fatalf("Error: should construct key with default OCC module name")
	}

	conn.Close()

	logger.GetLogger().Log(logger.Debug, "TestTTLCacheHappyPathWithDefaultModuleNameKey done +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
}
