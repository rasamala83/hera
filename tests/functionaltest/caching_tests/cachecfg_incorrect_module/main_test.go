...
func TestTTLCacheConfigWithIncorrectModuleName(t *testing.T) {
	...
	logger.GetLogger().Log(logger.Debug, "TestTTLCacheConfigWithIncorrectModuleName done +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
}
