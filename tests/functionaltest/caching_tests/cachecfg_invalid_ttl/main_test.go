...
func TestTTLCacheWithInvalidTTLConfig(t *testing.T) {
	logger.GetLogger().Log(logger.Debug, "TestTTLCacheWithInvalidTTLConfig begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
	testutil.RunDML("INSERT into hera_sql_caching (query_id, sqlhash, sqltext, bind_variables, TTL_sec, enable_shadow_test, tableName, invalidation_clause, caching_enabled, cache_by_corrid, caching_enabled_apps, remarks, hera_module) VALUES  ('1', '2904134799', 'MyTestQuery', 'abc=123', 2147483647, 'N', 'MyTestTable', '', 'Y', 'N', 'all', '', 'hera-test')")
	...
	if testutil.RegexCountFile("Error in setRecordToCache:.*bad parameter", "hera.log") < 1 {
	...
	logger.GetLogger().Log(logger.Debug, "TestTTLCacheWithInvalidTTLConfig done +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
}
