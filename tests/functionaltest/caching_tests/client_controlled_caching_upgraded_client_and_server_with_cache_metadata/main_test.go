...
// GET (Cache MISS) + SET
func TestClientControlledCacheUpgradedClientAndServerWithCacheMetadata(t *testing.T) {
	logger.GetLogger().Log(logger.Debug, "TestClientControlledCacheUpgradedClientAndServerWithCacheMetadata begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
	...
	if testutil.RegexCountFile("Trying GET with key: 510935701", "hera.log") < 2 {
		t.Fatalf("Error: should have entered this block")
	}
	...
	logger.GetLogger().Log(logger.Debug, "TestClientControlledCacheUpgradedClientAndServerWithCacheMetadata done +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
}
