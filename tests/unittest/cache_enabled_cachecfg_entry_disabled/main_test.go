...
func TestTTLCacheEnabledCacheCfgEntryDisabled(t *testing.T) {
	...
	err = testutil.RunDML("INSERT into hera_sql_caching (query_id, sqlhash, sqltext, bind_variables, TTL_sec, enable_shadow_test, tableName, invalidation_clause, caching_enabled, remarks, hera_module) VALUES  ('1', '2904134799', 'MyTestQuery', 'abc=123', 30, 'N', 'MyTestTable', '', 'N', '', 'hera-test')")
	testutil.CheckError(err, t)
