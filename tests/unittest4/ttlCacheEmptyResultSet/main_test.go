...
func before() error {
	...
	testutil.DBDirect("drop table testEmptyResultSet", os.Getenv("MYSQL_IP"), "heratestdb", testutil.MySQL)
	testutil.DBDirect("create table testEmptyResultSet (id INT, val MEDIUMTEXT)", os.Getenv("MYSQL_IP"), "heratestdb", testutil.MySQL)
	return nil
}
