...
func TestTTLCacheWithDifferentCorrIdAndCacheByCorrId(t *testing.T) {
	...
	if testutil.RegexCountFile("2733177372 CachingEnabled for  SET : true", "hera.log") < 10 {
		t.Fatalf("Error: should have entered this block for every corrId")
	}
