...
func TestTTLCacheWithInvalidTTLConfig(t *testing.T) {
	...
	testutil.RunDML("INSERT into hera_sql_caching (query_id, sqlhash, sqltext, bind_variables, TTL_sec, enable_shadow_test, tableName, invalidation_clause, caching_enabled, remarks, hera_module) VALUES  ('1', '2904134799', 'MyTestQuery', 'abc=123', 2147483647, 'N', 'MyTestTable', '', 'Y', '', 'hera-test')")
	...
	if testutil.RegexCountFile("coordinator DispatchCachingSession for SET returned:.*bad parameter", "hera.log") < 1 {
